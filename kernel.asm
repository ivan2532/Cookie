...
0000000080000000 <_entry>:
    ...
    80000004:	2c813103          	ld	sp,712(sp) # 800042c8 <_GLOBAL_OFFSET_TABLE_+0x8>
    80000008:	00001537          	lui	a0,0x1
    8000000c:	f14025f3          	csrr	a1,mhartid
    80000010:	00158593          	addi	a1,a1,1
    80000014:	02b50533          	mul	a0,a0,a1
    80000018:	00a10133          	add	sp,sp,a0
    8000001c:	51c010ef          	jal	ra,80001538 <start>
...
supervisorTrap:
    ...
    sd x2, 0x08(sp)
    80001008:	00213423          	sd	sp,8(sp)
    sd x3, 0x10(sp)
    8000100c:	00313823          	sd	gp,16(sp)
    sd x4, 0x18(sp)
    80001010:	00413c23          	sd	tp,24(sp)
    sd x5, 0x20(sp)
    80001014:	02513023          	sd	t0,32(sp)
    sd x6, 0x28(sp)
    80001018:	02613423          	sd	t1,40(sp)
    sd x7, 0x30(sp)
    8000101c:	02713823          	sd	t2,48(sp)
    sd x8, 0x38(sp)
    80001020:	02813c23          	sd	s0,56(sp)
    sd x9, 0x40(sp)
    80001024:	04913023          	sd	s1,64(sp)
    sd x12, 0x48(sp)
    ...
    sd x18, 0x78(sp)
    80001040:	07213c23          	sd	s2,120(sp)
    sd x19, 0x80(sp)
    80001044:	09313023          	sd	s3,128(sp)
    sd x20, 0x88(sp)
    80001048:	09413423          	sd	s4,136(sp)
    sd x21, 0x90(sp)
    8000104c:	09513823          	sd	s5,144(sp)
    sd x22, 0x98(sp)
    80001050:	09613c23          	sd	s6,152(sp)
    sd x23, 0xA0(sp)
    80001054:	0b713023          	sd	s7,160(sp)
    sd x24, 0xA8(sp)
    80001058:	0b813423          	sd	s8,168(sp)
    sd x25, 0xB0(sp)
    8000105c:	0b913823          	sd	s9,176(sp)
    sd x26, 0xB8(sp)
    80001060:	0ba13c23          	sd	s10,184(sp)
    sd x27, 0xC0(sp)
    80001064:	0db13023          	sd	s11,192(sp)
    sd x28, 0xC8(sp)
    80001068:	0dc13423          	sd	t3,200(sp)
    sd x29, 0xD0(sp)
    8000106c:	0dd13823          	sd	t4,208(sp)
    sd x30, 0xD8(sp)
    80001070:	0de13c23          	sd	t5,216(sp)
    sd x31, 0xE0(sp)
    80001074:	0ff13023          	sd	t6,224(sp)

    call handleSupervisorTrap
    80001078:	348000ef          	jal	ra,800013c0 <handleSupervisorTrap>

    # Restore all registers

    ld x1, 0x00(sp)
    8000107c:	00013083          	ld	ra,0(sp)
    ld x2, 0x08(sp)
    80001080:	00813103          	ld	sp,8(sp)
    ld x3, 0x10(sp)
    80001084:	01013183          	ld	gp,16(sp)
    ld x4, 0x18(sp)
    80001088:	01813203          	ld	tp,24(sp)
    ld x5, 0x20(sp)
    8000108c:	02013283          	ld	t0,32(sp)
    ld x6, 0x28(sp)
    80001090:	02813303          	ld	t1,40(sp)
    ld x7, 0x30(sp)
    80001094:	03013383          	ld	t2,48(sp)
    ld x8, 0x38(sp)
    80001098:	03813403          	ld	s0,56(sp)
    ld x9, 0x40(sp)
    8000109c:	04013483          	ld	s1,64(sp)
    ld x12, 0x48(sp)
    800010a0:	04813603          	ld	a2,72(sp)
    ld x13, 0x50(sp)
    800010a4:	05013683          	ld	a3,80(sp)
    ld x14, 0x58(sp)
    800010a8:	05813703          	ld	a4,88(sp)
    ld x15, 0x60(sp)
    800010ac:	06013783          	ld	a5,96(sp)
    ld x16, 0x68(sp)
    800010b0:	06813803          	ld	a6,104(sp)
    ld x17, 0x70(sp)
    800010b4:	07013883          	ld	a7,112(sp)
    ld x18, 0x78(sp)
    800010b8:	07813903          	ld	s2,120(sp)
    ld x19, 0x80(sp)
    800010bc:	08013983          	ld	s3,128(sp)
    ld x20, 0x88(sp)
    800010c0:	08813a03          	ld	s4,136(sp)
    ld x21, 0x90(sp)
    800010c4:	09013a83          	ld	s5,144(sp)
    ld x22, 0x98(sp)
    800010c8:	09813b03          	ld	s6,152(sp)
    ld x23, 0xA0(sp)
    800010cc:	0a013b83          	ld	s7,160(sp)
    ld x24, 0xA8(sp)
    800010d0:	0a813c03          	ld	s8,168(sp)
    ld x25, 0xB0(sp)
    800010d4:	0b013c83          	ld	s9,176(sp)
    ld x26, 0xB8(sp)
    800010d8:	0b813d03          	ld	s10,184(sp)
    ld x27, 0xC0(sp)
    800010dc:	0c013d83          	ld	s11,192(sp)
    ld x28, 0xC8(sp)
    800010e0:	0c813e03          	ld	t3,200(sp)
    ld x29, 0xD0(sp)
    800010e4:	0d013e83          	ld	t4,208(sp)
    ld x30, 0xD8(sp)
    800010e8:	0d813f03          	ld	t5,216(sp)
    ld x31, 0xE0(sp)
    800010ec:	0e013f83          	ld	t6,224(sp)

    addi sp, sp, 248
    800010f0:	0f810113          	addi	sp,sp,248

    800010f4:	10200073          	sret
	...
...
static void initFirstBlock()
{
    ...
    80001160:	00003717          	auipc	a4,0x3
    80001164:	15873703          	ld	a4,344(a4) # 800042b8 <HEAP_START_ADDR>
    firstBlock->size = (HEAP_END_ADDR - 1) - HEAP_START_ADDR;
    80001168:	00003797          	auipc	a5,0x3
    8000116c:	1487b783          	ld	a5,328(a5) # 800042b0 <HEAP_END_ADDR>
    80001170:	fff78793          	addi	a5,a5,-1
    80001174:	40e787b3          	sub	a5,a5,a4
    80001178:	00f73023          	sd	a5,0(a4)
    firstBlock->next = 0;
    8000117c:	00073823          	sd	zero,16(a4)
    freeBlocksList = firstBlock;
    80001180:	00003797          	auipc	a5,0x3
    80001184:	16e7b023          	sd	a4,352(a5) # 800042e0 <freeBlocksList>
}
    80001188:	00813403          	ld	s0,8(sp)
    8000118c:	01010113          	addi	sp,sp,16
    80001190:	00008067          	ret

0000000080001194 <splitFreeBlock>:
...
static Block* splitFreeBlock(Block* block, size_t neededSize)
{
    ...
    800011a0:	03f5f793          	andi	a5,a1,63
    800011a4:	04079063          	bnez	a5,800011e4 <splitFreeBlock+0x50>
    800011a8:	00053783          	ld	a5,0(a0) # 1000 <_entry-0x7ffff000>
    800011ac:	04b7e063          	bltu	a5,a1,800011ec <splitFreeBlock+0x58>
    {
        return 0;
    }
    ...
    800011b4:	03f00713          	li	a4,63
    800011b8:	02f77063          	bgeu	a4,a5,800011d8 <splitFreeBlock+0x44>
    {
        return block;
    }

    void* leftoverBlockAddress = (void*)block + neededSize;
    800011bc:	00b50733          	add	a4,a0,a1
    Block* leftoverBlock = (Block*)leftoverBlockAddress;
    leftoverBlock->size = block->size - neededSize;
    800011c0:	00f73023          	sd	a5,0(a4)
    leftoverBlock->prev = block;
    800011c4:	00a73423          	sd	a0,8(a4)
    leftoverBlock->next = block->next;
    800011c8:	01053783          	ld	a5,16(a0)
    800011cc:	00f73823          	sd	a5,16(a4)

    block->size = neededSize;
    800011d0:	00b53023          	sd	a1,0(a0)
    block->next = leftoverBlock;
    800011d4:	00e53823          	sd	a4,16(a0)
    ...
    800011e8:	ff1ff06f          	j	800011d8 <splitFreeBlock+0x44>
    800011ec:	00000513          	li	a0,0
    800011f0:	fe9ff06f          	j	800011d8 <splitFreeBlock+0x44>

00000000800011f4 <firstFit>:
...
static Block* firstFit(size_t minSize)
{
    ...
    80001210:	0d47b783          	ld	a5,212(a5) # 800042e0 <freeBlocksList>
    80001214:	02078663          	beqz	a5,80001240 <firstFit+0x4c>
    {
        initFirstBlock();
    }

    Block* iterator = freeBlocksList;
    80001218:	00003517          	auipc	a0,0x3
    8000121c:	0c853503          	ld	a0,200(a0) # 800042e0 <freeBlocksList>

    while (iterator != 0)
    80001220:	00050663          	beqz	a0,8000122c <firstFit+0x38>
    {
        if (iterator->size < minSize)
    80001224:	00053783          	ld	a5,0(a0)
    80001228:	0297e263          	bltu	a5,s1,8000124c <firstFit+0x58>
    ...
    80001244:	f14080e7          	jalr	-236(ra) # 80001154 <initFirstBlock>
    80001248:	fd1ff06f          	j	80001218 <firstFit+0x24>
            iterator = iterator->next;
    8000124c:	01053503          	ld	a0,16(a0)
            continue;
    80001250:	fd1ff06f          	j	80001220 <firstFit+0x2c>

0000000080001254 <mergeBlocks>:
...
static Block* mergeBlocks(Block* parent, Block* child)
{
    ...
    80001260:	0005b683          	ld	a3,0(a1)
    80001264:	00053703          	ld	a4,0(a0)
    80001268:	00d70733          	add	a4,a4,a3
    8000126c:	00e53023          	sd	a4,0(a0)
    parent->next = child->next;
    80001270:	0105b703          	ld	a4,16(a1)
    80001274:	00e53823          	sd	a4,16(a0)
...
0000000080001284 <kernel_alloc>:

// Allocate a memory block of "size" bytes on the heap.
void* kernel_alloc(size_t size)
{
    if(size == 0)
    80001284:	08050a63          	beqz	a0,80001318 <kernel_alloc+0x94>
{
    ...
    return ( (size - 1) / MEM_BLOCK_SIZE + 1) * MEM_BLOCK_SIZE;
    8000129c:	01750493          	addi	s1,a0,23
    800012a0:	0064d493          	srli	s1,s1,0x6
    800012a4:	00148493          	addi	s1,s1,1
    800012a8:	00649493          	slli	s1,s1,0x6
    ...
    800012b0:	0347b783          	ld	a5,52(a5) # 800042e0 <freeBlocksList>
    800012b4:	04078c63          	beqz	a5,8000130c <kernel_alloc+0x88>
    {
        initFirstBlock();
    }
    ...
    800012c0:	f38080e7          	jalr	-200(ra) # 800011f4 <firstFit>
    if(blockToAllocate == 0)
    800012c4:	02050a63          	beqz	a0,800012f8 <kernel_alloc+0x74>
    {
        return 0;
    }
    ...
    80001310:	e48080e7          	jalr	-440(ra) # 80001154 <initFirstBlock>
    80001314:	fa5ff06f          	j	800012b8 <kernel_alloc+0x34>
        return 0;
    80001318:	00000513          	li	a0,0
}
    8000131c:	00008067          	ret

0000000080001320 <kernel_free>:
...
int kernel_free(void* ptr)
{
    ...
    80001338:	fe850513          	addi	a0,a0,-24
    ...
    8000133c:	ff04b783          	ld	a5,-16(s1)
    80001340:	00078863          	beqz	a5,80001350 <kernel_free+0x30>
    80001344:	fe84b703          	ld	a4,-24(s1)
    80001348:	00e78733          	add	a4,a5,a4
    8000134c:	02a70863          	beq	a4,a0,8000137c <kernel_free+0x5c>
    ...
    80001350:	ff84b583          	ld	a1,-8(s1)
    80001354:	00058863          	beqz	a1,80001364 <kernel_free+0x44>
    80001358:	00053783          	ld	a5,0(a0)
    8000135c:	00f507b3          	add	a5,a0,a5
    80001360:	02f58863          	beq	a1,a5,80001390 <kernel_free+0x70>
    ...
    80001388:	ed0080e7          	jalr	-304(ra) # 80001254 <mergeBlocks>
    8000138c:	fc5ff06f          	j	80001350 <kernel_free+0x30>
        mergeBlocks(blockToMergeWith, descriptor->next);
    80001390:	00000097          	auipc	ra,0x0
    80001394:	ec4080e7          	jalr	-316(ra) # 80001254 <mergeBlocks>
    80001398:	fcdff06f          	j	80001364 <kernel_free+0x44>

000000008000139c <moveSEPCAfterECALL>:
// ---------------------------------------------------------------
...
static void moveSEPCAfterECALL()
{
    ...
    800013a8:	141025f3          	csrr	a1,sepc
...
void handleSupervisorTrap()
{
    ...
    800013d0:	14202773          	csrr	a4,scause
    ...
    800013d4:	ff870693          	addi	a3,a4,-8
    800013d8:	00100793          	li	a5,1
    800013dc:	00d7fe63          	bgeu	a5,a3,800013f8 <handleSupervisorTrap+0x38>
    ...
    800013ec:	02f71663          	bne	a4,a5,80001418 <handleSupervisorTrap+0x58>
    {
        // Clear first bit of SIP (Supervisor Interrupt Pending) register
        __asm__ volatile ("csrc sip, 0x02");
    800013f0:	14417073          	csrci	sip,2
    800013f4:	0240006f          	j	80001418 <handleSupervisorTrap+0x58>
        __asm__ volatile ("mv %[outCode], a0" : [outCode] "=r" (sysCallCode));
    800013f8:	00050793          	mv	a5,a0
        switch (sysCallCode)
    800013fc:	00100713          	li	a4,1
    80001400:	02e78863          	beq	a5,a4,80001430 <handleSupervisorTrap+0x70>
    80001404:	00200713          	li	a4,2
    80001408:	02e78e63          	beq	a5,a4,80001444 <handleSupervisorTrap+0x84>
        __asm__ volatile ("csrc sip, 0x02");
    8000140c:	14417073          	csrci	sip,2
        moveSEPCAfterECALL();
    80001410:	00000097          	auipc	ra,0x0
    80001414:	f8c080e7          	jalr	-116(ra) # 8000139c <moveSEPCAfterECALL>
    }

    // Console interrupt routine
    console_handler();
    80001418:	00002097          	auipc	ra,0x2
    8000141c:	258080e7          	jalr	600(ra) # 80003670 <console_handler>
}
    ...
    80001438:	e50080e7          	jalr	-432(ra) # 80001284 <kernel_alloc>
                __asm__ volatile ("mv a0, %[inReturnValue]" : : [inReturnValue] "r" (returnValue));
    8000143c:	00050513          	mv	a0,a0
                break;
    80001440:	fcdff06f          	j	8000140c <handleSupervisorTrap+0x4c>
                __asm__ volatile ("mv %[outPtr], a1" : [outPtr] "=r" (ptrArg));
    80001444:	00058513          	mv	a0,a1
                int returnValue = kernel_free(ptrArg);
    80001448:	00000097          	auipc	ra,0x0
    8000144c:	ed8080e7          	jalr	-296(ra) # 80001320 <kernel_free>
                __asm__ volatile ("mv a0, %[inReturnValue]" : : [inReturnValue] "r" (returnValue));
    80001450:	00050513          	mv	a0,a0
                break;
    80001454:	fb9ff06f          	j	8000140c <handleSupervisorTrap+0x4c>

0000000080001458 <setTrap>:
...
void setTrap()
{
    ...
    80001464:	00000797          	auipc	a5,0x0
    80001468:	b9c78793          	addi	a5,a5,-1124 # 80001000 <supervisorTrap>
    8000146c:	10579073          	csrw	stvec,a5
    ...
    80001470:	10016073          	csrsi	sstatus,2
...
int main()
{
    ...
    80001498:	fc4080e7          	jalr	-60(ra) # 80001458 <setTrap>

    char* testAlloc = new char;
    8000149c:	00100513          	li	a0,1
    800014a0:	00000097          	auipc	ra,0x0
    800014a4:	048080e7          	jalr	72(ra) # 800014e8 <_Znwm>
    800014a8:	00050493          	mv	s1,a0
    *testAlloc = 'a';
    800014ac:	06100793          	li	a5,97
    800014b0:	00f50023          	sb	a5,0(a0)

    __putc(*testAlloc);
    800014b4:	06100513          	li	a0,97
    800014b8:	00002097          	auipc	ra,0x2
    800014bc:	144080e7          	jalr	324(ra) # 800035fc <__putc>

    delete testAlloc;
    800014c0:	00048863          	beqz	s1,800014d0 <main+0x50>
    800014c4:	00048513          	mv	a0,s1
    800014c8:	00000097          	auipc	ra,0x0
    800014cc:	048080e7          	jalr	72(ra) # 80001510 <_ZdlPv>
...
void* operator new (size_t size)
{
    ...
    800014fc:	c08080e7          	jalr	-1016(ra) # 80001100 <__mem_alloc>
}
...
void operator delete (void* ptr)
{
    ...
    80001524:	c08080e7          	jalr	-1016(ra) # 80001128 <__mem_free>
}
...
0000000080001538 <start>:
    80001538:	ff010113          	addi	sp,sp,-16
    8000153c:	00813423          	sd	s0,8(sp)
    80001540:	01010413          	addi	s0,sp,16
    80001544:	300027f3          	csrr	a5,mstatus
    80001548:	ffffe737          	lui	a4,0xffffe
    8000154c:	7ff70713          	addi	a4,a4,2047 # ffffffffffffe7ff <end+0xffffffff7fff929f>
    80001550:	00e7f7b3          	and	a5,a5,a4
    80001554:	00001737          	lui	a4,0x1
    80001558:	80070713          	addi	a4,a4,-2048 # 800 <_entry-0x7ffff800>
    8000155c:	00e7e7b3          	or	a5,a5,a4
    80001560:	30079073          	csrw	mstatus,a5
    80001564:	00000797          	auipc	a5,0x0
    80001568:	16078793          	addi	a5,a5,352 # 800016c4 <system_main>
    8000156c:	34179073          	csrw	mepc,a5
    80001570:	00000793          	li	a5,0
    80001574:	18079073          	csrw	satp,a5
    80001578:	000107b7          	lui	a5,0x10
    8000157c:	fff78793          	addi	a5,a5,-1 # ffff <_entry-0x7fff0001>
    80001580:	30279073          	csrw	medeleg,a5
    80001584:	30379073          	csrw	mideleg,a5
    80001588:	104027f3          	csrr	a5,sie
    8000158c:	2227e793          	ori	a5,a5,546
    80001590:	10479073          	csrw	sie,a5
    80001594:	fff00793          	li	a5,-1
    80001598:	00a7d793          	srli	a5,a5,0xa
    8000159c:	3b079073          	csrw	pmpaddr0,a5
    800015a0:	00f00793          	li	a5,15
    800015a4:	3a079073          	csrw	pmpcfg0,a5
    800015a8:	f14027f3          	csrr	a5,mhartid
    800015ac:	0200c737          	lui	a4,0x200c
    800015b0:	ff873583          	ld	a1,-8(a4) # 200bff8 <_entry-0x7dff4008>
    800015b4:	0007869b          	sext.w	a3,a5
    800015b8:	00269713          	slli	a4,a3,0x2
    800015bc:	000f4637          	lui	a2,0xf4
    800015c0:	24060613          	addi	a2,a2,576 # f4240 <_entry-0x7ff0bdc0>
    800015c4:	00d70733          	add	a4,a4,a3
    800015c8:	0037979b          	slliw	a5,a5,0x3
    800015cc:	020046b7          	lui	a3,0x2004
    800015d0:	00d787b3          	add	a5,a5,a3
    800015d4:	00c585b3          	add	a1,a1,a2
    800015d8:	00371693          	slli	a3,a4,0x3
    800015dc:	00003717          	auipc	a4,0x3
    800015e0:	d3470713          	addi	a4,a4,-716 # 80004310 <timer_scratch>
    800015e4:	00b7b023          	sd	a1,0(a5)
    800015e8:	00d70733          	add	a4,a4,a3
    800015ec:	00f73c23          	sd	a5,24(a4)
    800015f0:	02c73023          	sd	a2,32(a4)
    800015f4:	34071073          	csrw	mscratch,a4
    800015f8:	00000797          	auipc	a5,0x0
    800015fc:	6e878793          	addi	a5,a5,1768 # 80001ce0 <timervec>
    80001600:	30579073          	csrw	mtvec,a5
    80001604:	300027f3          	csrr	a5,mstatus
    80001608:	0087e793          	ori	a5,a5,8
    8000160c:	30079073          	csrw	mstatus,a5
    80001610:	304027f3          	csrr	a5,mie
    80001614:	0807e793          	ori	a5,a5,128
    80001618:	30479073          	csrw	mie,a5
    8000161c:	f14027f3          	csrr	a5,mhartid
    80001620:	0007879b          	sext.w	a5,a5
    80001624:	00078213          	mv	tp,a5
    80001628:	30200073          	mret
    8000162c:	00813403          	ld	s0,8(sp)
    80001630:	01010113          	addi	sp,sp,16
    80001634:	00008067          	ret

0000000080001638 <timerinit>:
    ...
    8000167c:	c9870713          	addi	a4,a4,-872 # 80004310 <timer_scratch>
    ...
    80001698:	64c78793          	addi	a5,a5,1612 # 80001ce0 <timervec>
...
00000000800016c4 <system_main>:
    ...
    800016dc:	0c4080e7          	jalr	196(ra) # 8000179c <cpuid>
    800016e0:	00003497          	auipc	s1,0x3
    800016e4:	c0848493          	addi	s1,s1,-1016 # 800042e8 <started>
    800016e8:	02050263          	beqz	a0,8000170c <system_main+0x48>
    800016ec:	0004a783          	lw	a5,0(s1)
    800016f0:	0007879b          	sext.w	a5,a5
    800016f4:	fe078ce3          	beqz	a5,800016ec <system_main+0x28>
    ...
    80001708:	a78080e7          	jalr	-1416(ra) # 8000217c <panic>
    8000170c:	00001097          	auipc	ra,0x1
    80001710:	9cc080e7          	jalr	-1588(ra) # 800020d8 <consoleinit>
    80001714:	00001097          	auipc	ra,0x1
    80001718:	158080e7          	jalr	344(ra) # 8000286c <printfinit>
    8000171c:	00003517          	auipc	a0,0x3
    80001720:	a1450513          	addi	a0,a0,-1516 # 80004130 <CONSOLE_STATUS+0x120>
    80001724:	00001097          	auipc	ra,0x1
    80001728:	ab4080e7          	jalr	-1356(ra) # 800021d8 <__printf>
    8000172c:	00003517          	auipc	a0,0x3
    80001730:	8f450513          	addi	a0,a0,-1804 # 80004020 <CONSOLE_STATUS+0x10>
    80001734:	00001097          	auipc	ra,0x1
    80001738:	aa4080e7          	jalr	-1372(ra) # 800021d8 <__printf>
    8000173c:	00003517          	auipc	a0,0x3
    80001740:	9f450513          	addi	a0,a0,-1548 # 80004130 <CONSOLE_STATUS+0x120>
    80001744:	00001097          	auipc	ra,0x1
    80001748:	a94080e7          	jalr	-1388(ra) # 800021d8 <__printf>
    8000174c:	00001097          	auipc	ra,0x1
    80001750:	4ac080e7          	jalr	1196(ra) # 80002bf8 <kinit>
    80001754:	00000097          	auipc	ra,0x0
    80001758:	148080e7          	jalr	328(ra) # 8000189c <trapinit>
    8000175c:	00000097          	auipc	ra,0x0
    80001760:	16c080e7          	jalr	364(ra) # 800018c8 <trapinithart>
    80001764:	00000097          	auipc	ra,0x0
    80001768:	5bc080e7          	jalr	1468(ra) # 80001d20 <plicinit>
    8000176c:	00000097          	auipc	ra,0x0
    80001770:	5dc080e7          	jalr	1500(ra) # 80001d48 <plicinithart>
    80001774:	00000097          	auipc	ra,0x0
    80001778:	078080e7          	jalr	120(ra) # 800017ec <userinit>
    8000177c:	0ff0000f          	fence
    80001780:	00100793          	li	a5,1
    80001784:	00003517          	auipc	a0,0x3
    80001788:	8b450513          	addi	a0,a0,-1868 # 80004038 <CONSOLE_STATUS+0x28>
    8000178c:	00f4a023          	sw	a5,0(s1)
    80001790:	00001097          	auipc	ra,0x1
    80001794:	a48080e7          	jalr	-1464(ra) # 800021d8 <__printf>
    80001798:	0000006f          	j	80001798 <system_main+0xd4>

000000008000179c <cpuid>:
    8000179c:	ff010113          	addi	sp,sp,-16
    800017a0:	00813423          	sd	s0,8(sp)
    800017a4:	01010413          	addi	s0,sp,16
    800017a8:	00020513          	mv	a0,tp
    800017ac:	00813403          	ld	s0,8(sp)
    800017b0:	0005051b          	sext.w	a0,a0
    800017b4:	01010113          	addi	sp,sp,16
    800017b8:	00008067          	ret

00000000800017bc <mycpu>:
...
00000000800017ec <userinit>:
    ...
    80001800:	00000317          	auipc	t1,0x0
    80001804:	c8030067          	jr	-896(t1) # 80001480 <main>

0000000080001808 <either_copyout>:
    80001808:	ff010113          	addi	sp,sp,-16
    8000180c:	00813023          	sd	s0,0(sp)
    80001810:	00113423          	sd	ra,8(sp)
    80001814:	01010413          	addi	s0,sp,16
    80001818:	02051663          	bnez	a0,80001844 <either_copyout+0x3c>
    8000181c:	00058513          	mv	a0,a1
    80001820:	00060593          	mv	a1,a2
    80001824:	0006861b          	sext.w	a2,a3
    80001828:	00002097          	auipc	ra,0x2
    8000182c:	c5c080e7          	jalr	-932(ra) # 80003484 <__memmove>
    ...
    80001848:	83450513          	addi	a0,a0,-1996 # 80004078 <CONSOLE_STATUS+0x68>
    8000184c:	00001097          	auipc	ra,0x1
    80001850:	930080e7          	jalr	-1744(ra) # 8000217c <panic>

0000000080001854 <either_copyin>:
    80001854:	ff010113          	addi	sp,sp,-16
    80001858:	00813023          	sd	s0,0(sp)
    8000185c:	00113423          	sd	ra,8(sp)
    80001860:	01010413          	addi	s0,sp,16
    80001864:	02059463          	bnez	a1,8000188c <either_copyin+0x38>
    80001868:	00060593          	mv	a1,a2
    8000186c:	0006861b          	sext.w	a2,a3
    80001870:	00002097          	auipc	ra,0x2
    80001874:	c14080e7          	jalr	-1004(ra) # 80003484 <__memmove>
    ...
    80001890:	81450513          	addi	a0,a0,-2028 # 800040a0 <CONSOLE_STATUS+0x90>
    80001894:	00001097          	auipc	ra,0x1
    80001898:	8e8080e7          	jalr	-1816(ra) # 8000217c <panic>
...
000000008000189c <trapinit>:
    ...
    800018ac:	00003597          	auipc	a1,0x3
    800018b0:	81c58593          	addi	a1,a1,-2020 # 800040c8 <CONSOLE_STATUS+0xb8>
    800018b4:	00004517          	auipc	a0,0x4
    800018b8:	b0c50513          	addi	a0,a0,-1268 # 800053c0 <tickslock>
    800018bc:	01010113          	addi	sp,sp,16
    800018c0:	00001317          	auipc	t1,0x1
    800018c4:	5c830067          	jr	1480(t1) # 80002e88 <initlock>

00000000800018c8 <trapinithart>:
    800018c8:	ff010113          	addi	sp,sp,-16
    800018cc:	00813423          	sd	s0,8(sp)
    800018d0:	01010413          	addi	s0,sp,16
    800018d4:	00000797          	auipc	a5,0x0
    800018d8:	2fc78793          	addi	a5,a5,764 # 80001bd0 <kernelvec>
    800018dc:	10579073          	csrw	stvec,a5
    800018e0:	00813403          	ld	s0,8(sp)
    800018e4:	01010113          	addi	sp,sp,16
    800018e8:	00008067          	ret

00000000800018ec <usertrap>:
...
000000008000191c <kerneltrap>:
    ...
    80001930:	142025f3          	csrr	a1,scause
    80001934:	100027f3          	csrr	a5,sstatus
    80001938:	0027f793          	andi	a5,a5,2
    8000193c:	10079c63          	bnez	a5,80001a54 <kerneltrap+0x138>
    80001940:	142027f3          	csrr	a5,scause
    80001944:	0207ce63          	bltz	a5,80001980 <kerneltrap+0x64>
    80001948:	00002517          	auipc	a0,0x2
    8000194c:	7c850513          	addi	a0,a0,1992 # 80004110 <CONSOLE_STATUS+0x100>
    80001950:	00001097          	auipc	ra,0x1
    80001954:	888080e7          	jalr	-1912(ra) # 800021d8 <__printf>
    80001958:	141025f3          	csrr	a1,sepc
    8000195c:	14302673          	csrr	a2,stval
    80001960:	00002517          	auipc	a0,0x2
    80001964:	7c050513          	addi	a0,a0,1984 # 80004120 <CONSOLE_STATUS+0x110>
    80001968:	00001097          	auipc	ra,0x1
    8000196c:	870080e7          	jalr	-1936(ra) # 800021d8 <__printf>
    80001970:	00002517          	auipc	a0,0x2
    80001974:	7c850513          	addi	a0,a0,1992 # 80004138 <CONSOLE_STATUS+0x128>
    80001978:	00001097          	auipc	ra,0x1
    8000197c:	804080e7          	jalr	-2044(ra) # 8000217c <panic>
    80001980:	0ff7f713          	andi	a4,a5,255
    80001984:	00900693          	li	a3,9
    80001988:	04d70063          	beq	a4,a3,800019c8 <kerneltrap+0xac>
    8000198c:	fff00713          	li	a4,-1
    80001990:	03f71713          	slli	a4,a4,0x3f
    80001994:	00170713          	addi	a4,a4,1
    80001998:	fae798e3          	bne	a5,a4,80001948 <kerneltrap+0x2c>
    8000199c:	00000097          	auipc	ra,0x0
    800019a0:	e00080e7          	jalr	-512(ra) # 8000179c <cpuid>
    800019a4:	06050663          	beqz	a0,80001a10 <kerneltrap+0xf4>
    800019a8:	144027f3          	csrr	a5,sip
    800019ac:	ffd7f793          	andi	a5,a5,-3
    800019b0:	14479073          	csrw	sip,a5
    ...
    800019cc:	3cc080e7          	jalr	972(ra) # 80001d94 <plic_claim>
    800019d0:	00a00793          	li	a5,10
    800019d4:	00050493          	mv	s1,a0
    800019d8:	06f50863          	beq	a0,a5,80001a48 <kerneltrap+0x12c>
    800019dc:	fc050ce3          	beqz	a0,800019b4 <kerneltrap+0x98>
    800019e0:	00050593          	mv	a1,a0
    800019e4:	00002517          	auipc	a0,0x2
    800019e8:	70c50513          	addi	a0,a0,1804 # 800040f0 <CONSOLE_STATUS+0xe0>
    800019ec:	00000097          	auipc	ra,0x0
    800019f0:	7ec080e7          	jalr	2028(ra) # 800021d8 <__printf>
    ...
    80001a08:	00000317          	auipc	t1,0x0
    80001a0c:	3c430067          	jr	964(t1) # 80001dcc <plic_complete>
    80001a10:	00004517          	auipc	a0,0x4
    80001a14:	9b050513          	addi	a0,a0,-1616 # 800053c0 <tickslock>
    80001a18:	00001097          	auipc	ra,0x1
    80001a1c:	494080e7          	jalr	1172(ra) # 80002eac <acquire>
    80001a20:	00003717          	auipc	a4,0x3
    80001a24:	8cc70713          	addi	a4,a4,-1844 # 800042ec <ticks>
    80001a28:	00072783          	lw	a5,0(a4)
    80001a2c:	00004517          	auipc	a0,0x4
    80001a30:	99450513          	addi	a0,a0,-1644 # 800053c0 <tickslock>
    80001a34:	0017879b          	addiw	a5,a5,1
    80001a38:	00f72023          	sw	a5,0(a4)
    80001a3c:	00001097          	auipc	ra,0x1
    80001a40:	53c080e7          	jalr	1340(ra) # 80002f78 <release>
    80001a44:	f65ff06f          	j	800019a8 <kerneltrap+0x8c>
    80001a48:	00001097          	auipc	ra,0x1
    80001a4c:	098080e7          	jalr	152(ra) # 80002ae0 <uartintr>
    80001a50:	fa5ff06f          	j	800019f4 <kerneltrap+0xd8>
    80001a54:	00002517          	auipc	a0,0x2
    80001a58:	67c50513          	addi	a0,a0,1660 # 800040d0 <CONSOLE_STATUS+0xc0>
    80001a5c:	00000097          	auipc	ra,0x0
    80001a60:	720080e7          	jalr	1824(ra) # 8000217c <panic>
...
0000000080001a64 <clockintr>:
    ...
    80001a7c:	94848493          	addi	s1,s1,-1720 # 800053c0 <tickslock>
    80001a80:	00048513          	mv	a0,s1
    80001a84:	00001097          	auipc	ra,0x1
    80001a88:	428080e7          	jalr	1064(ra) # 80002eac <acquire>
    80001a8c:	00003717          	auipc	a4,0x3
    80001a90:	86070713          	addi	a4,a4,-1952 # 800042ec <ticks>
    80001a94:	00072783          	lw	a5,0(a4)
    80001a98:	01013403          	ld	s0,16(sp)
    80001a9c:	01813083          	ld	ra,24(sp)
    80001aa0:	00048513          	mv	a0,s1
    80001aa4:	0017879b          	addiw	a5,a5,1
    80001aa8:	00813483          	ld	s1,8(sp)
    80001aac:	00f72023          	sw	a5,0(a4)
    80001ab0:	02010113          	addi	sp,sp,32
    80001ab4:	00001317          	auipc	t1,0x1
    80001ab8:	4c430067          	jr	1220(t1) # 80002f78 <release>

0000000080001abc <devintr>:
    80001abc:	142027f3          	csrr	a5,scause
    80001ac0:	00000513          	li	a0,0
    80001ac4:	0007c463          	bltz	a5,80001acc <devintr+0x10>
    ...
    80001ae0:	0ff7f713          	andi	a4,a5,255
    80001ae4:	00900693          	li	a3,9
    80001ae8:	04d70c63          	beq	a4,a3,80001b40 <devintr+0x84>
    80001aec:	fff00713          	li	a4,-1
    80001af0:	03f71713          	slli	a4,a4,0x3f
    80001af4:	00170713          	addi	a4,a4,1
    80001af8:	00e78c63          	beq	a5,a4,80001b10 <devintr+0x54>
    ...
    80001b14:	c8c080e7          	jalr	-884(ra) # 8000179c <cpuid>
    80001b18:	06050663          	beqz	a0,80001b84 <devintr+0xc8>
    80001b1c:	144027f3          	csrr	a5,sip
    80001b20:	ffd7f793          	andi	a5,a5,-3
    80001b24:	14479073          	csrw	sip,a5
    ...
    80001b44:	254080e7          	jalr	596(ra) # 80001d94 <plic_claim>
    80001b48:	00a00793          	li	a5,10
    80001b4c:	00050493          	mv	s1,a0
    80001b50:	06f50663          	beq	a0,a5,80001bbc <devintr+0x100>
    80001b54:	00100513          	li	a0,1
    80001b58:	fa0482e3          	beqz	s1,80001afc <devintr+0x40>
    80001b5c:	00048593          	mv	a1,s1
    80001b60:	00002517          	auipc	a0,0x2
    80001b64:	59050513          	addi	a0,a0,1424 # 800040f0 <CONSOLE_STATUS+0xe0>
    80001b68:	00000097          	auipc	ra,0x0
    80001b6c:	670080e7          	jalr	1648(ra) # 800021d8 <__printf>
    80001b70:	00048513          	mv	a0,s1
    80001b74:	00000097          	auipc	ra,0x0
    80001b78:	258080e7          	jalr	600(ra) # 80001dcc <plic_complete>
    80001b7c:	00100513          	li	a0,1
    80001b80:	f7dff06f          	j	80001afc <devintr+0x40>
    80001b84:	00004517          	auipc	a0,0x4
    80001b88:	83c50513          	addi	a0,a0,-1988 # 800053c0 <tickslock>
    80001b8c:	00001097          	auipc	ra,0x1
    80001b90:	320080e7          	jalr	800(ra) # 80002eac <acquire>
    80001b94:	00002717          	auipc	a4,0x2
    80001b98:	75870713          	addi	a4,a4,1880 # 800042ec <ticks>
    80001b9c:	00072783          	lw	a5,0(a4)
    80001ba0:	00004517          	auipc	a0,0x4
    80001ba4:	82050513          	addi	a0,a0,-2016 # 800053c0 <tickslock>
    80001ba8:	0017879b          	addiw	a5,a5,1
    80001bac:	00f72023          	sw	a5,0(a4)
    80001bb0:	00001097          	auipc	ra,0x1
    80001bb4:	3c8080e7          	jalr	968(ra) # 80002f78 <release>
    80001bb8:	f65ff06f          	j	80001b1c <devintr+0x60>
    80001bbc:	00001097          	auipc	ra,0x1
    80001bc0:	f24080e7          	jalr	-220(ra) # 80002ae0 <uartintr>
    80001bc4:	fadff06f          	j	80001b70 <devintr+0xb4>
	...
...
0000000080001bd0 <kernelvec>:
    ...
    80001c50:	ccdff0ef          	jal	ra,8000191c <kerneltrap>
...
0000000080001d48 <plicinithart>:
    ...
    80001d5c:	a44080e7          	jalr	-1468(ra) # 8000179c <cpuid>
...
0000000080001d94 <plic_claim>:
    ...
    80001da8:	9f8080e7          	jalr	-1544(ra) # 8000179c <cpuid>
...
0000000080001dcc <plic_complete>:
    ...
    80001de8:	9b8080e7          	jalr	-1608(ra) # 8000179c <cpuid>
...
0000000080001e10 <consolewrite>:
    ...
    80001e7c:	9dc080e7          	jalr	-1572(ra) # 80001854 <either_copyin>
...
0000000080001eb4 <consoleread>:
    ...
    80001efc:	4e048493          	addi	s1,s1,1248 # 800053d8 <cons>
    ...
    80001f54:	8b8080e7          	jalr	-1864(ra) # 80001808 <either_copyout>
...
0000000080002044 <consoleintr>:
    ...
    80002060:	37c90913          	addi	s2,s2,892 # 800053d8 <cons>
    ...
    800020c0:	31c50513          	addi	a0,a0,796 # 800053d8 <cons>
...
00000000800020d8 <consoleinit>:
    ...
    800020f0:	2ec48493          	addi	s1,s1,748 # 800053d8 <cons>
...
000000008000213c <console_read>:
    ...
    80002150:	34433303          	ld	t1,836(t1) # 80005490 <devsw+0x10>
...
000000008000215c <console_write>:
    ...
    80002170:	32c33303          	ld	t1,812(t1) # 80005498 <devsw+0x18>
...
000000008000217c <panic>:
    ...
    800021a0:	3807ae23          	sw	zero,924(a5) # 80005538 <pr+0x18>
    ...
    800021d0:	12f72223          	sw	a5,292(a4) # 800042f0 <panicked>
...
00000000800021d8 <__printf>:
    ...
    80002218:	30c30313          	addi	t1,t1,780 # 80005520 <pr>
    ...
    80002628:	efc50513          	addi	a0,a0,-260 # 80005520 <pr>
...
000000008000286c <printfinit>:
    ...
    80002884:	ca048493          	addi	s1,s1,-864 # 80005520 <pr>
...
00000000800028f8 <uartputc>:
    ...
    800028fc:	9f87a783          	lw	a5,-1544(a5) # 800042f0 <panicked>
    ...
    80002928:	9d490913          	addi	s2,s2,-1580 # 800042f8 <uart_tx_r>
    8000292c:	00093783          	ld	a5,0(s2)
    80002930:	00002497          	auipc	s1,0x2
    80002934:	9d048493          	addi	s1,s1,-1584 # 80004300 <uart_tx_w>
    ...
    80002984:	bc058593          	addi	a1,a1,-1088 # 80005540 <uart_tx_buf>
...
00000000800029f0 <uartputc_sync>:
    ...
    80002a00:	8f472703          	lw	a4,-1804(a4) # 800042f0 <panicked>
...
0000000080002a34 <uartstart>:
    ...
    80002a44:	8b860613          	addi	a2,a2,-1864 # 800042f8 <uart_tx_r>
    80002a48:	00002517          	auipc	a0,0x2
    80002a4c:	8b850513          	addi	a0,a0,-1864 # 80004300 <uart_tx_w>
    ...
    80002a64:	ae080813          	addi	a6,a6,-1312 # 80005540 <uart_tx_buf>
...
0000000080002ae0 <uartintr>:
    ...
    80002b24:	00001617          	auipc	a2,0x1
    80002b28:	7d460613          	addi	a2,a2,2004 # 800042f8 <uart_tx_r>
    80002b2c:	00001517          	auipc	a0,0x1
    80002b30:	7d450513          	addi	a0,a0,2004 # 80004300 <uart_tx_w>
    ...
    80002b48:	9fc80813          	addi	a6,a6,-1540 # 80005540 <uart_tx_buf>
    ...
    80002b98:	76460613          	addi	a2,a2,1892 # 800042f8 <uart_tx_r>
    80002b9c:	00001517          	auipc	a0,0x1
    80002ba0:	76450513          	addi	a0,a0,1892 # 80004300 <uart_tx_w>
    ...
    80002bb8:	98c80813          	addi	a6,a6,-1652 # 80005540 <uart_tx_buf>
...
0000000080002bf8 <kinit>:
    ...
    80002c08:	95b48493          	addi	s1,s1,-1701 # 8000655f <end+0xfff>
    ...
    80002c44:	920a8a93          	addi	s5,s5,-1760 # 80005560 <end>
    ...
    80002c5c:	6b090913          	addi	s2,s2,1712 # 80004308 <kmem>
...
0000000080002cd0 <freerange>:
    ...
    80002d18:	84ca8a93          	addi	s5,s5,-1972 # 80005560 <end>
    ...
    80002d34:	5d890913          	addi	s2,s2,1496 # 80004308 <kmem>
...
0000000080002db0 <kfree>:
    ...
    80002dcc:	00002797          	auipc	a5,0x2
    80002dd0:	79478793          	addi	a5,a5,1940 # 80005560 <end>
    ...
    80002dfc:	51078793          	addi	a5,a5,1296 # 80004308 <kmem>
...
0000000080002e30 <kalloc>:
    ...
    80002e48:	4c478793          	addi	a5,a5,1220 # 80004308 <kmem>
...
0000000080002eac <acquire>:
    ...
    80002edc:	8e4080e7          	jalr	-1820(ra) # 800017bc <mycpu>
    80002ee0:	07852783          	lw	a5,120(a0)
    80002ee4:	06078e63          	beqz	a5,80002f60 <acquire+0xb4>
    80002ee8:	fffff097          	auipc	ra,0xfffff
    80002eec:	8d4080e7          	jalr	-1836(ra) # 800017bc <mycpu>
    ...
    80002f20:	8a0080e7          	jalr	-1888(ra) # 800017bc <mycpu>
    ...
    80002f48:	878080e7          	jalr	-1928(ra) # 800017bc <mycpu>
    ...
    80002f68:	858080e7          	jalr	-1960(ra) # 800017bc <mycpu>
...
0000000080002f78 <release>:
    ...
    80002fb4:	80c080e7          	jalr	-2036(ra) # 800017bc <mycpu>
    ...
    80002fd0:	7f0080e7          	jalr	2032(ra) # 800017bc <mycpu>
...
0000000080003040 <holding>:
    ...
    8000306c:	754080e7          	jalr	1876(ra) # 800017bc <mycpu>
...
000000008000308c <push_off>:
    ...
    800030f0:	6d0080e7          	jalr	1744(ra) # 800017bc <mycpu>
...
0000000080003100 <pop_off>:
    ...
    80003114:	6ac080e7          	jalr	1708(ra) # 800017bc <mycpu>
...
000000008000317c <push_on>:
    ...
    800031e0:	5e0080e7          	jalr	1504(ra) # 800017bc <mycpu>
...
00000000800031f0 <pop_on>:
    ...
    80003204:	5bc080e7          	jalr	1468(ra) # 800017bc <mycpu>
